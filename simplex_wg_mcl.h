#ifndef _SIMPLEX_MONOLITHIC_WG_CL_H
#define _SIMPLEX_MONOLITHIC_WG_CL_H

#include "simplex.h"
#include "clutil.h"


class MonolithicWorkgroupSimplexCLSolver : public Solver {
public:
    MonolithicWorkgroupSimplexCLSolver();
    ~MonolithicWorkgroupSimplexCLSolver();
